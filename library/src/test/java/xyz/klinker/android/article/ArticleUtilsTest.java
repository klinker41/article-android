...
public class ArticleUtilsTest extends MessengerRobolectricSuite {

    @Test
    public void test_isImageUrl_jpg() {
        assertTrue(ArticleUtils.isImageUrl("http://google.com/image.jpg"));
    }

    @Test
    public void test_isImageUrl_png() {
        assertTrue(ArticleUtils.isImageUrl("http://google.com/image.png"));
    }

    @Test
    public void test_isImageUrl_gif() {
        assertTrue(ArticleUtils.isImageUrl("http://google.com/image.gif"));
    }

    @Test
    public void test_isNotImageUrl() {
